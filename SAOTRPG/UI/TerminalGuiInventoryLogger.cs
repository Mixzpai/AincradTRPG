...
public class TerminalGuiInventoryLogger : IInventoryLogger
{
    ...
    // ── Item lifecycle ──────────────────────────────────────────────
    public void LogItemAdded(BaseItem item)       => _log.LogLoot($"Added {item.Name} to inventory.");
    public void LogItemRemoved(BaseItem item)     => _log.LogLoot($"Removed {item.Name} from inventory.");
