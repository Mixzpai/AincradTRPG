...
public partial class TurnManager
{
    ...
    private string DescribeTerrain(Tile tile) => tile.Type switch
    {
        ...
        TileType.TrapWeb       => "Sticky strands glisten between the stones...",
        TileType.TrapMagnet    => "The air here feels oddly heavy...",
        TileType.TrapRune      => "A faded sigil is carved into the floor...",
